...
const CurrentDateTimeBar = () => {
  ...
  return (
    <div className="flex items-center justify-between mb-1 pb-1 border-b border-indigo-100 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-md px-3 py-2 flex-shrink-0">
